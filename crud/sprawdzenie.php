...
<head>
    ...
    <title>sprawdzenie danych</title>
</head>
<body>
        ...
        $plecodp = "mężczyzna";
         ...
         {  $plecodp = "kobieta";
           ...
           if ($wszystko_git) {
            ...
            $stmt = $conn->prepare("INSERT INTO uzytkownicy (imie, nazwisko, wiek, pesel, email, ulica, kodpocztowy, plec) 
            ...
            if ($stmt->execute()) {
                header('Location: glowna.php?msg=Dane zapisano w bazie danych');
            } else {
                echo "Błąd przy zapisywaniu danych. Spróbuj ponownie!";
                echo '<br /><a href="dodaj.php">Spróbuj ponownie!</a> <br />';
            }
